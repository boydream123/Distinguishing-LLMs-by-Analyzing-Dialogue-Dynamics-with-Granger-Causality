...
- [Getting Started](##getting-started)
  ...
  - [Obtaining the Original Data](##obtaining-the-original-data)
...
* `type` (String): Dialogue type ("human-human" or "human-computer").
